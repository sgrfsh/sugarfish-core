...
$language_data = array(
    ...
    'KEYWORDS' => array(
        1 => array(
            'as','break','case','catch','continue','default','do','else','elseif',
            'endfor','endforeach','endif','endswitch','endwhile','finally','for',
        ...
        2 => array(
            ...
            'class','const','declare','extends','function','global','implements', 'interface',
    ...
    'STYLES' => array(
        ...
        'COMMENTS' => array(
            ...
            3 => 'color:#666; font-style: italic;',
            4 => 'color:#666; font-style: italic;',
            'MULTI' => 'color:#666; font-style: italic;'
            ),
        'ESCAPE_CHAR' => array(
            0 => 'color:#009; font-weight: bold;',
            1 => 'color:#009; font-weight: bold;',
            2 => 'color:#609; font-weight: bold;',
            3 => 'color:#609; font-weight: bold;',
            4 => 'color:#069; font-weight: bold;',
            5 => 'color:#069; font-weight: bold; font-style: italic;',
            6 => 'color:#093; font-weight: bold;',
            'HARD' => 'color:#009; font-weight: bold;'
            ),
        'BRACKETS' => array(
            0 => 'color:#006;'
            ),
